...
namespace ET.Analyzer
{
    ...
    public class StaticClassCircularDependencyAnalyzer: DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Rule = new(DiagnosticIds.StaticClassCircularDedendencyAnalyzerRuleId,
            Title,
            MessageFormat,
            DiagnosticCategories.Hotfix,
            DiagnosticSeverity.Error, true, Description, helpLinkUri, WellKnownDiagnosticTags.CompilationEnd);
