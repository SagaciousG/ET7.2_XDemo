...
namespace ET.Analyzer
{
    ...
    public class AddChildTypeAnalyzer: DiagnosticAnalyzer
    {
        ...
        private void AnalyzeMemberAccessExpression(SyntaxNodeAnalysisContext context)
        {
            ...
            bool ignoreAddChildAnalyzer= parentTypeSymbol.GetAttributes().Any(x => x.AttributeClass?.ToString() == Definition.IgnoreAddChildAnalyzerAttribute);
            if(ignoreAddChildAnalyzer)
                return;
