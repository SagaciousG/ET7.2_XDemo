...
using System.Collections.Generic;
 ...
 namespace ET
{
    public partial class UIList : MonoBehaviour, IPointerDownHandler
    {
        [SerializeField]
        ...
        [SerializeField]
        private float _cellScale = 1;

        [SerializeField] private bool _isPrefabAsset;
        ...
        private RectTransform GetRender()
        {
            ...
            if (this.OnSelectedViewRefresh != null || OnSelectedDataRefresh != null)
            {
    ...
    public interface IUIListCellDrawer
    {
