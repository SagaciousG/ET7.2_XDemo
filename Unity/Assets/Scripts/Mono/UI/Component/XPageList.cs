...
namespace ET
{
    public class XPageList : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollRect
    {
        ...
        private void Start()
        {
            ...
            PagePoints.OnSelectedViewRefresh += PagePoints_OnSelected;
        }

        private void PagePoints_OnSelected(RectTransform arg1, bool arg2, object arg3, int arg4)
        {
        }
