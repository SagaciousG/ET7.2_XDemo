...
namespace ET
{
    public static class GUILayoutHelper
    {
        ...
        public static T EnumPopup<T>(GUIContent content, T val) where T : Enum
        {
            EnumPopup(content, ref val);
            return val;
        }
        ...
        public static void TitleLabel(string label)
        {
            TitleLabel(new GUIContent(label));
        }
        ...
        public static bool ToogleButton(ref bool on, GUIContent content, Color onColor, params GUILayoutOption[] options)
        {
            var btn = new GUIStyle(GUI.skin.button);
            btn.richText = true;
            return ToogleButton(ref on, content, onColor, btn, options);
        }
        ...
        public static int Popup(GUIContent label, int index, string[] contents, params GUILayoutOption[] options)
        {
