...
namespace ET
{
    ...
    public static class PSDParse
    {
        ...
        private static void UpdatePrefab(PSDLayerGroup layer, GameObject node, List<UnityEngine.Object> objs)
        {
        ...
        private static void Group2UGUI(RectTransform node, PSDLayerGroup group, List<UnityEngine.Object> objs)
        {
