...
namespace ET
{
	...
	[ProtoContract]
	public partial class G2C_AddOnlinePlayerAMessage: ProtoObject, ICenterMessage
	{
		[ProtoMember(90)]
	...
	[ProtoContract]
	public partial class R2C_EnterZoneARequest: ProtoObject, ICenterRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_EnterZoneAResponse: ProtoObject, ICenterResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_IsOnlineARequest: ProtoObject, ICenterRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_IsOnlineAResponse: ProtoObject, ICenterResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_RemoveOnlinePlayerAMessage: ProtoObject, ICenterMessage
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_ServerZoneStateARequest: ProtoObject, ICenterRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_ServerZoneStateAResponse: ProtoObject, ICenterResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class R2C_ZoneStateAMessage: ProtoObject, ICenterMessage
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerMessage.R2G_KickOutPlayerAMessage)]
	[ProtoContract]
	public partial class R2G_KickOutPlayerAMessage: ProtoObject, IActorMessage
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	public static partial class InnerMessage
	{
		 ...
		 public const ushort R2C_IsOnlineARequest = 20105;
		 public const ushort R2C_IsOnlineAResponse = 20106;
		 ...
		 public const ushort R2G_KickOutPlayerAMessage = 20113;
		 public const ushort R2G_QueryZonePlayerARequest = 20114;
		 public const ushort R2G_QueryZonePlayerAResponse = 20115;
		 public const ushort ZonePlayer = 20116;
	}
}
