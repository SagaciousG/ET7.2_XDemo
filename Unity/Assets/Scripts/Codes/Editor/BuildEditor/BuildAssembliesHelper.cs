            ...
            switch (codeMode)
            {
                case CodeMode.Client:
                    codes = new List<string>()
                    {
                        ...
                        "Assets/Scripts/Codes/Model/ConfigPartial/Client/",
                        "Assets/Scripts/Codes/Model/ConfigPartial/ClientServer/",
                ...
                case CodeMode.Server:
                    codes = new List<string>()
                    {
                        ...
                        "Assets/Scripts/Codes/Model/ConfigPartial/Server/",
                        "Assets/Scripts/Codes/Model/ConfigPartial/ClientServer/",
                        "Assets/Scripts/Codes/Model/Share/",
                ...
                case CodeMode.ClientServer:
                    codes = new List<string>()
                    {
                        ...
                        "Assets/Scripts/Codes/ModelView/",
                        "Assets/Scripts/Codes/Model/Generate/ClientServer",
                        "Assets/Scripts/Codes/Model/ConfigPartial/",
                        "Assets/Scripts/Codes/Model/Server/",
                    };
                    break;
                default:
