namespace ET.Server
{
    public class GateComponentAwakeSystem : AwakeSystem<GateComponent>
    {
        ...
        {
            MessageHelper.SendCenter(new R2C_ZoneStateAMessage(){IsOnline = 1, Zone = self.DomainZone()});
        }
    }
    ...
    public class GateComponentDestorySystem: DestroySystem<GateComponent>
    {
        ...
        {
            MessageHelper.SendCenter(new R2C_ZoneStateAMessage(){IsOnline = 0, Zone = self.DomainZone()});
        }
    }
